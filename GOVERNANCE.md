...
`cloud-itonami-isic-2812` is an OSS open-business blueprint for
fluid-power-equipment plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a machining/assembly-line-equipment action the governor refuses is never dispatched to hardware.
- the Fluid Power Equipment Plant Operations Governor remains independent of the advisor.
...
- bypassing machining/assembly-line-equipment-control or record policy checks
