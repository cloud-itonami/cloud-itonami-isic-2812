# Business Model: Manufacture of fluid power equipment
...
## Classification
- Repository: `cloud-itonami-isic-2812` ([github.com/cloud-itonami/cloud-itonami-isic-2812](https://github.com/cloud-itonami/cloud-itonami-isic-2812))
- ISIC Rev.5: `2812` — Manufacture of fluid power equipment
- Domain: `:fluid-power/manufacturing`
- Social impact: :worker-safety :pressure-safety :hydraulic-fluid-safety :equipment-safety
- Actor: `:fluid-power-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :fluid-power/manufacturing — who wants
...
One managed tenant (:fluid-power/manufacturing):
...
- Do not bypass the `:fluid-power-plant-operations-governor` for production decisions.
