# Operator Quickstart — Manufacture of fluid power equipment

Shortest path from clone to a verified local dry-run for **ISIC 2812** (`cloud-itonami-isic-2812`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2812.git
cd cloud-itonami-isic-2812
```
...
- Blueprint governor key: `fluid-power-plant-operations-governor`
- Likely source path: `fluidpowermfg.governor.cljc`
