(ns fluidpowermfg.phase
  "Phase 0->3 staged rollout for the fluid-power-equipment (hydraulic
  pumps, hydraulic cylinders, hydraulic valves, hydraulic motors,
  pneumatic cylinders, pneumatic valves) plant-operations coordination
  actor.
  ...
  consequence (a machining/assembly/pressure-test-bench-equipment
  ...
  `fluidpowermfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Fluid Power Equipment Plant Operations Governor verdict to a
